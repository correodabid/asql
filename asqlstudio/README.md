...
- The Ops area includes a `Security` panel for durable principal bootstrap, user/role creation, grants and revocations, password rotation, and principal disablement over the admin HTTP surface.