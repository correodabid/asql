...
> Historical note
>
> This roadmap describes an earlier bootstrap phase of ASQL and is no longer current.
>
> Use these docs instead:
>
> - [docs/ai/05-backlog.md](05-backlog.md) for active execution
> - [../production-readiness-roadmap-v1.md](../production-readiness-roadmap-v1.md) for current production-readiness direction
> - [../../.github/copilot-instructions.md](../../.github/copilot-instructions.md) for current product/runtime stance
