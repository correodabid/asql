// Package fixtures defines the deterministic fixture format used to seed
// and export ASQL domains. It provides pure parsing, validation, and
// apply/export helpers that depend only on the pgwire protocol and are
// safe for external clients to import.
package fixtures
...
// BeginStatement renders the BEGIN DOMAIN / BEGIN CROSS DOMAIN statement for a
// fixture step. Exported so engine-side helpers that need to replay fixtures
// share the same transaction-opening syntax.
