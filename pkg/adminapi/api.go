// Package adminapi defines the public request/response types for the ASQL
// admin HTTP API. These types are stable across the pgwire server's admin
// endpoints and are suitable for use by external clients.
package adminapi
